...
class Alarms:
    def __init__(self, tr, input=[], fp=None):
        self.tr = tr
        self.input = input
        self.fp = fp
    ...
    async def set_alarms(self):
        ...
        for isin in isins:
            print(f"Current alarms for {isin}: {sorted(current_alarms[isin].keys())}")
        ...
        for isin in isins:
            ...
            print(f"Adding alarms for {isin}: {new_alarms[isin]}")
            print(f"Removing alarms for {isin}: {sorted(current_alarms[isin].keys())}")
